...
<table>
  ...
  <tr>
    <td rowspan="5" valign="top"><strong>3</strong></td>
    <td valign="top">
      <ul>
  ...
  <tr>
    ...
    <td valign="top">
      <ul>
        ...
        <li><a href="https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05j-Testing-Resiliency-Against-Reverse-Engineering.md#testing-anti-debugging-detection-mstg-resilience-2">Add antidebugging detection</a>
        <li><span style="text-decoration:underline;">Android</span>: It is recommended to use more advanced obfuscators than Proguard to make obfuscation process more complex than default one
        <li><span style="text-decoration:underline;">iOS</span>: Use obfuscation to hinder reverse engineering</li>
      </ul>
    </td>
...
OWASP recently (January 2020) recommended for iOS [iOSSecuritySuite](https://github.com/securing/IOSSecuritySuite) to check JailBreak detection and other stuff like debbuger or emulator detection.
