...
- [Technical requirements for security levels](#technical-requirements-for-security-levels)
- [Requirements description](#requirements-description)
   - [Encrypted HTTP communication](#encrypted-http-communication)
   - [Screenshot disabling](#screenshot-disabling)
   - [User dictionary protection](#user-dictionary-protection)
   - [Backup disabling](#backup-disabling)
   - [Logs protection](#logs-protection)
   - [User credential handling](#user-credential-handling)
   - [Brute force attack](#brute-force-attack)
   - [Rainbow tables attack](#rainbow-tables-attack)
   - [Cryptographic hash function](#cryptographic-hash-function)
   - [Obfuscation](#obfuscation)
   - [Backend keys handling](#backend-keys-handling)
   - [OWASP Mobile Top 10 requirements](#owasp-mobile-top-10-requirements)
   - [Root/jailbreak detection](#root/jailbreak=detection)
   - [Proper system permission handling](#proper-system-permission-handling)
   - [Intrusion Detection System](#intrusion-detection-system)
   - [Data wiping on logout](#data-wiping-on-logout)
...
Application should be compliant with all relevant requirements arising from [OWASP Mobile Top 10 List](https://www.owasp.org/index.php/OWASP_Mobile_Security_Project). The list contains most critical and common issues that can be found in mobile applications during the current year. The list is being updated once every two years.
