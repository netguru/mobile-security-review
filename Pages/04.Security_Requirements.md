  ...
  <tr>
    ...
    <td valign="top">
      <ul>
        ...
        <li>Add antidebugging detection: <a href="https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06j-Testing-Resiliency-Against-Reverse-Engineering.md#anti-debugging-checks-mstg-resilience-2">iOS</a>,  <a href="https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05j-Testing-Resiliency-Against-Reverse-Engineering.md#testing-anti-debugging-detection-mstg-resilience-2">Android</a>
